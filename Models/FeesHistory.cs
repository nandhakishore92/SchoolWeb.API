...
namespace SchoolWeb.API.Models
{
    public class FeesHistory
    {
		...
		#region Audit Fees
		public int AuditFeesDefault => TuitionFees + SchoolManagementFees + BookFees + BusFees;

		public int AuditFees2223 => TuitionFees + BookFees + BusFees + SpecialClassFees + UniformFees + MiscellaneousFees;
